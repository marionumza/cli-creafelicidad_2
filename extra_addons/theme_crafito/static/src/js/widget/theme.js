        ...
        colorpicker.on('colorpicker:saved', this, function (ev) {
            ...
            // TODO improve to be more efficient
                ...
                if(colorName === 'crafito_primary'){
		            ...
		            var baseURL = '/theme_crafito/static/src/scss/colors/color_picker.scss';                                
                     		self._rpc({
							    ...
							    self._rpc({
								    ...
								    params: {
								        url: '/theme_crafito/static/src/scss/colors/color_picker.scss',
                ...
                if(colorName === 'crafito_secondary'){
                    ...
                    var baseURL = '/theme_crafito/static/src/scss/colors/color_picker_sec.scss';                                
                            self._rpc({
                                route: '/web_editor/get_assets_editor_resources',
                                params: {
                                    key: 'website.layout',
                                ...
                                self._rpc({
                                    ...
                                    params: {
                                        url: '/theme_crafito/static/src/scss/colors/color_picker_sec.scss',
                                        bundle_xmlid: 'web.assets_frontend',
                                        content: updatedFileContent,
                                    },
                                }).then(function (d){
