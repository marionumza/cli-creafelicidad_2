...
class PosOrder(models.Model):
    ...
    def _create_account_move(self, dt, ref, journal_id, company_id , operating_unit_id):
        ...
        return self.env['account.move'].sudo().create({'ref': ref, 'journal_id': journal_id, 'date': date_tz_user ,'operating_unit_id':operating_unit_id.id})
        ...
        for order in self.filtered(lambda o: not o.account_move or o.state == 'paid'):
            ...
            if move is None:
                ...
                move = self._create_account_move(
                    order.session_id.start_at, order.name, int(journal_id), order.company_id.id , order.operating_unit_id)
...
class pos_session(models.Model):
    ...
    def _confirm_orders(self):
        for session in self:
            ...
            move = self.env['pos.order'].with_context(force_company=company_id)._create_account_move(session.start_at, session.name, int(journal_id), company_id , session.operating_unit_id)
...
class account_bank_statement(models.Model):
    ...
    operating_unit_id = fields.Many2one('operating.unit', 'operating unit', related='pos_session_id.operating_unit_id',required=True)
...
class account_bank_statement_line(models.Model):
    ...
    operating_unit_id = fields.Many2one('operating.unit', 'operating unit', related='statement_id.operating_unit_id',required=True)
    ...
    def process_reconciliation(self, counterpart_aml_dicts=None, payment_aml_rec=None, new_aml_dicts=None):
        ...
        for aml_rec in payment_aml_rec:
            ...
            aml_rec.write({'operating_unit_id': self.operating_unit_id.id})
        ...
        if counterpart_aml_dicts or new_aml_dicts:
            ...
            move_vals.update({'operating_unit_id': self.operating_unit_id.id})
            ...
            for aml_dict in to_create:
                ...
                aml_dict['operating_unit_id'] = self.operating_unit_id.id
        ...
        for line in self.statement_id.line_ids:
            for move_line in line.journal_entry_ids:
                move_line.operating_unit_id = line.operating_unit_id.id 
...
class StockMoveInherit(models.Model):
    ...
    def _create_account_move_line(self, credit_account_id, debit_account_id, journal_id):
        ...
        if move_lines:
            ...
            if self.env.user.default_operating_unit_id.id:
